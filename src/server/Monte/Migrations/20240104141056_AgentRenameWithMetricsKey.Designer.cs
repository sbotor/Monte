...
namespace Monte.Migrations
{
    ...
    [Migration("20240104141056_AgentRenameWithMetricsKey")]
    partial class AgentRenameWithMetricsKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monte.Features.Agents.Agent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Monte.Features.Agents.Agent", b =>
                {
                    b.OwnsOne("Monte.Features.Agents.Agent+CpuInfo", "Cpu", b1 =>
                        {
                    ...
                    b.OwnsOne("Monte.Features.Agents.Agent+MemoryInfo", "Memory", b1 =>
                        {
                            b1.Property<Guid>("AgentId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Monte.Features.Metrics.MetricsEntry", b =>
                {
                    b.HasOne("Monte.Features.Agents.Agent", null)
                        .WithMany()
                        .HasForeignKey("AgentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
